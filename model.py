...
class ImgNN(nn.Module):
    def __init__(self, input_dim=2048, mindum_dim=512, out_dim=128, dropout_prob=0.3):
...
class TextNN(nn.Module):
    def __init__(self, input_dim=768, mindum_dim=512, out_dim=128, dropout_prob=0.3):
...
class model(nn.Module):
    def __init__(self, num_class, img_dim=1024, text_dim=1024, mid_dim=256, feature_dim=384, init_weight=True):
